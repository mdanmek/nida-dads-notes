...
#### ภาพรวมรอบแรกแบบไม่ใช้ศัพท์เทคนิค

นึกถึงหนังสือเล่มใหญ่มากที่ฉีกเป็นหลายมัดแล้วทำสำเนาเก็บในโกดังหลายแห่ง “บรรณารักษ์” จดว่าแต่ละมัดอยู่ที่ใด แต่ไม่เก็บเนื้อหนังสือเอง เมื่อมีงานนับคำ “ผู้จัดคิว” เลือกคนและทรัพยากรไปทำงานใกล้โกดังที่มีมัดนั้น หากโกดังหนึ่งเสีย ยังอ่านสำเนาจากแห่งอื่นได้

เมื่อแปลงเป็นศัพท์จริง: คลัสเตอร์คือกลุ่มเครื่อง, node คือเครื่องหนึ่งตัว, HDFS block คือชิ้นไฟล์, metadata คือสารบัญตำแหน่ง block, replication คือการมีหลายสำเนา, NameNode คล้ายผู้ดูแลสารบัญ, DataNode เก็บ bytes จริง และ YARN จัด resources สำหรับ applications อุปมานี้มีขอบเขต: NameNode ในระบบจริงเป็นบริการซอฟต์แวร์ที่มี HA ได้ ไม่ใช่คนหรือศูนย์กลางส่ง bytes ทุกครั้ง
