...
แหล่งหลัก: `dads6002_01_hadoop.pdf` จำนวน 43 หน้า และ `lab_01_hadoop.pdf` จำนวน 5 หน้า ชุดนี้เรียบเรียงใหม่ตามมาตรฐานการอธิบายแบบขยายความ โดยเริ่มจากปัญหาและตัวอย่างภาษาธรรมดา ก่อนแมปไปยังศัพท์ของระบบ แล้วจึงเชื่อมกับคำสั่งและผลที่ตรวจสอบได้ใน Lab
...
### วิธีอ่านชุด Hadoop สำหรับผู้เริ่มต้น

เริ่ม 01.1 ด้วยคำถามว่า “เหตุใดปัญหาข้อมูลบางชนิดจึงต้องเปลี่ยนทั้งวิธีเก็บและวิธีประมวลผล” จากนั้น 01.2 ติดตามไฟล์จริงว่า HDFS แบ่งและทำสำเนาอย่างไร พร้อมแยกให้ชัดว่า HDFS ดูแลข้อมูล ส่วน YARN ดูแลทรัพยากร เมื่อพื้นฐานสองส่วนนี้มั่นคงแล้วจึงอ่าน 01.3 เพื่อดูว่า MapReduce แบ่ง record สร้าง key รวบรวมค่าที่เกี่ยวข้อง และรวมเป็นคำตอบอย่างไร สุดท้าย 01.4 ขยายจากการควบคุมข้อมูลภายใน job ไปสู่การควบคุม dependency ระหว่างหลาย jobs

หลังอ่านกลไก HDFS ใน 01.2 ให้ทำ Lab หน้า 1–3 และพิสูจน์ความต่างระหว่างไฟล์ local กับ path ใน HDFS ด้วย `put`, `get` และ `diff` หลังเข้าใจ Word Count ใน 01.3 แล้วจึงทำ Lab หน้า 4–5 โดยทำนาย mapper output ก่อนรัน ตรวจว่าผลรวม counts เท่ากับจำนวน tokens และทดลองเอา `sort` หรือ final flush ออกหนึ่งครั้ง การทดลองเช่นนี้ทำให้คำสั่งเป็นหลักฐานของทฤษฎี ไม่ใช่ขั้นตอนที่ท่องตามสไลด์
