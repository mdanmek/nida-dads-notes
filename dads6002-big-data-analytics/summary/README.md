...
ชุด Master Notes ภาษาไทยจาก dads6002_01_hadoop.pdf จำนวน 43 หน้า จัดเป็นบทเรียนสำหรับผู้เริ่มต้น โดยแยกตาม learning units เพื่อให้แต่ละหัวข้อมีคำอธิบาย กลไก ตัวอย่าง failure/trade-off และแบบฝึกหัดครบถ้วน

## ลำดับการเรียน

1. [บทที่ 1: Big Data Foundations, Workflow และ Data Lake](011_big_data_foundations.md) — หน้า 1–10
2. [บทที่ 2: Hadoop Architecture, HDFS และ YARN](012_hdfs_and_yarn.md) — หน้า 11–21
3. [บทที่ 3: MapReduce, Hadoop Streaming และการปรับประสิทธิภาพ](013_mapreduce_and_streaming.md) — หน้า 22–38
4. [บทที่ 4: Partitioner, Job Chaining และ Workflow Orchestration](014_workflow_orchestration.md) — หน้า 39–43
